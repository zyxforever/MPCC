...
class ImageNet10(Dataset):
    ...
    def __init__(self, split='train',
        ...
        self.classes = ['king penguin','Maltese','snow leopard','airliner','airship','container ship','soccer ball','sports car','trailer truck','orange']
    ...
    def __loadfile(self):
        datas,labels = [],[]
        source_dataset = torchvision.datasets.ImageFolder(root='/root/data/datasets/imagenet-10')
